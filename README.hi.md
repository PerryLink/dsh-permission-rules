...
- **निदान** — अवरुद्ध कनेक्शन `[network: …]` संदेश लेकर आते हैं, और यदि मॉडल कॉल विफल होते समय प्रॉक्सी ने कोई लक्ष्य अवरुद्ध किया हो (इंजेक्ट किया गया प्रॉक्सी वातावरण होस्ट के LLM ट्रांसपोर्ट तक भी पहुँचता है), तो विफलता संदेश उस लक्ष्य और समाधान का नाम लेता है — केवल कच्चा ट्रांसपोर्ट त्रुटि नहीं दिखाता।
...
- **LLM प्रदाता endpoints के लिए allow नियम चाहिए।** इंजेक्ट किया गया प्रॉक्सी वातावरण पूरे प्रोसेस का है, इसलिए whitelist मोड में होस्ट का अपना मॉडल ट्रांसपोर्ट भी किसी अन्य कनेक्शन की तरह adjudicate होता है, और प्लगइन यह गिन नहीं सकता कि कोई adapter किन endpoints को कॉल करेगा (provider routes केवल ids देते हैं, और configured base URLs हर adapter की अपनी settings में रहते हैं)। प्रदाता endpoint के लिए allow नियम जोड़ें, या होस्ट प्रोसेस को प्रॉक्सी से बाहर रखने के लिए `network.injectEnv: false` सेट करें।
